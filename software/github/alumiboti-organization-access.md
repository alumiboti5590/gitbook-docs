...
{% tabs %}
{% tab title="Requesting Access to the Organization" %}
...
<figure><img src="../../.gitbook/assets/image.png" alt="GitHub signup page" width="563"><figcaption><p>The signup page for GitHub (as of early 2026)</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (1).png" alt="" width="375"><figcaption><p>Accept the invitation to join the organization to complete the process</p></figcaption></figure>
...
{% tab title="Approving Access to the Organization" %}
{% hint style="info" %}
...
<figure><img src="../../.gitbook/assets/image (2).png" alt="" width="563"><figcaption><p>The "Invite member" button in the top-right corner</p></figcaption></figure>

Input the new member's username (easiest) or email address and confirm the dialog box to initiate the invite process.

<figure><img src="../../.gitbook/assets/image (3).png" alt="" width="375"><figcaption><p>Member selection dialog popup</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (4).png" alt="" width="563"><figcaption><p>Student team page example, with the "Add" button in the top-right corner</p></figcaption></figure>
{% endtab %}
{% endtabs %}
